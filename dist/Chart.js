...
function drawBackgroundColors(scale) {
	...
	for (i = getValueCount(scale) - 1; i >= 0; i--) {
		...
		backgroundColor = helpers$1.isArray(opts.backgroundColors.color) ? opts.backgroundColors.color[i] : opts.backgroundColors.color;
	...
	draw: function() {
		...
		if (opts.display) {
			...
			if (opts.backgroundColors && opts.backgroundColors.display && opts.backgroundColors.color &&
				(!helpers$1.isArray(opts.backgroundColors.color) || opts.backgroundColors.color.length === getValueCount(me))) {
...
var adapter$1 = core_adapters._date;
